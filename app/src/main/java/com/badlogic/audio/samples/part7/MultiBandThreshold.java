...
public class MultiBandThreshold {
    ...
    public static void main(String[] argv) throws Exception {
        FileInputStream input = getFileInputStream(MultiBandThreshold.class, FILE);
        MP3Decoder decoder = new MP3Decoder(input);
        ...
        new PlaybackVisualizer(plot, HOP_SIZE, new MP3Decoder(getFileInputStream(AudioDevice.class, FILE)));
    }
}
